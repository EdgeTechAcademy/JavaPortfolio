    ...
    public static List<Patient> loadRecords(String fileName) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                //    							Last,First,Temp,Systolic,Diastolic,Height,Weight,Age,Feel
                Patient patient = new Patient(aLine[0], aLine[1], Integer.parseInt(aLine[2]), Integer.parseInt(aLine[3]), Integer.parseInt(aLine[4]), Integer.parseInt(aLine[5]), Integer.parseInt(aLine[6]), Integer.parseInt(aLine[7]), Integer.parseInt(aLine[8]));
